...
export default function emailTemplate (message, name){ 
        ...
        <body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: white;">
                    ...
                    <table role="presentation"  cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td style="text-align: center;">
                                ...
                                <span class="position"><br>Hope you have a good day.<br><strong>Regards,   Team</strong></span>
                            </td>
                            </tr>
                    </table>
                </td>
            ...
            <table  role="presentation" cellspacing="0" cellpadding="0"  width="100%" style="margin: auto;">
                ...
                <td class="bg_light" style="text-align: center;">
                    <p>© Copyright 2020   Team. All rights reserved.</p>
                </td>
                </tr>
            </table>
